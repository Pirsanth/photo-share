...
import { faPlusSquare, faUser, faImages, faFolder, faClock, faCamera, faArrowUp,
  faArrowDown, faThumbsUp, faTrashAlt, faUserPlus, faUserCircle, faInfoCircle, faBars, faPortrait} from '@fortawesome/free-solid-svg-icons';
...
library.add(faPlusSquare, faUser, faImages, faFolder, faClock, faCamera, faArrowUp,
   faArrowDown, faThumbsUp, faTrashAlt, faUserPlus, faUserCircle, faInfoCircle, faBars, faPortrait);
